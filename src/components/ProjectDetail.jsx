...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        github: selectedProject.github || "https://github.com/gavstoria",
      };
  ...
  const projectUrl = `https://github.com/gavstoria/project/${toSlug(project.title)}`;

  return (
    <>
      <Helmet>
        <title>{project.title} — Yoga Pangestu</title>
        <meta
          name="description"
          content={
            project.description
              ? project.description.slice(0, 155)
              : `Project ${project.title} oleh Yoga Pangestu — Frontend Developer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.title} — Yoga Pangestu`}
        />
        <meta
        ...
        <script type="application/ld+json">{`
          {
            ...
            "author": {
              "@type": "Person",
              "name": "Yoga Pangestu",
              "url": "https://github.com/gavstoria"
            }
          }
        `}</script>
      </Helmet>
